...
print("1. Increase promotions for high-performing products like PhoneX.")
print("2. Focus marketing in top-performing regions to maximize revenue.")
print("3. Address missing price and units data to improve analysis accuracy.")
